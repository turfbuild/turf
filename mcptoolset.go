...
var turfToolInfo = map[string]struct {
	...
	"config_init":   {"plan", "Init Config"},
	"config_plan":   {"plan", "Plan Config"},
	"module_init":   {"plan", "Init Module"},
	"module_plan":   {"plan", "Plan Module"},
	"resource_plan": {"plan", "Plan Resource"},
	"action_plan":   {"plan", "Plan Action"},
	"action_unplan": {"plan", "Unplan Action"},
	"outputs_plan":  {"plan", "Plan Outputs"},
